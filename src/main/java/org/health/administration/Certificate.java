...
public class Certificate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Certificate</title>");            
            out.println("</head>");
            out.println("<body>");
            
            
//            out.println("<h1>Servlet saveV at " + request.getContextPath() + "</h1>");
//            out.println("NOT FORWARDING");
            ...
            request.setAttribute("health_centres", centres);
            request.setAttribute("date_of_administration", admin);
            request.setAttribute("batch_number", batch);
            request.setAttribute("vaccine", vaccine);
            
            out.println(nin);
//                dispatch to certificate view to view certificate and store data
